                                ...
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        <li><img class="zoom ing-fluid w-100"
                                                src="{{ asset('frontend/images/zoom1.jpg') }}" alt="product">
                                        </li>
                                        <li><img class="zoom ing-fluid w-100"
                                                src="{{ asset('frontend/images/zoom2.jpg') }}" alt="product">
                                        </li>
                                        <li><img class="zoom ing-fluid w-100"
                                                src="{{ asset('frontend/images/zoom3.jpg') }}" alt="product">
                                        </li>
                                        <li><img class="zoom ing-fluid w-100"
                                                src="{{ asset('frontend/images/zoom4.jpg') }}" alt="product">
                                        </li>
                                        <li><img class="zoom ing-fluid w-100"
                                                src="{{ asset('frontend/images/zoom1.jpg') }}" alt="product">
                                        </li>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-xxl-5 col-md-6">
                                                <div class="wsus__vebdor_img">
                                                    <img src="{{ asset('frontend/images/slider_1.jpg') }}"
